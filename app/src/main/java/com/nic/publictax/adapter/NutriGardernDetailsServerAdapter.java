...
import com.nic.publictax.activity.ViewNutriGarden;
...
public class NutriGardernDetailsServerAdapter extends RecyclerView.Adapter<NutriGardernDetailsServerAdapter.MyViewHolder> {
    ...
    com.nic.publictax.dataBase.dbData dbData;
    private LayoutInflater layoutInflater;

    public NutriGardernDetailsServerAdapter(Activity context, List<PublicTax> pendingListValues, dbData dbData) {
