...
import com.nic.publictax.databinding.GalleryThumbnailBinding;
...
public class FullImageAdapter extends RecyclerView.Adapter<FullImageAdapter.MyViewHolder> {
    ...
    private List<PublicTax> imagePreviewlistvalues;
    private final com.nic.publictax.dataBase.dbData dbData;
    private LayoutInflater layoutInflater;

    public FullImageAdapter(Context context, List<PublicTax> imagePreviewlistvalues, dbData dbData) {
