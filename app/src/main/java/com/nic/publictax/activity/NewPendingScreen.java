...
import com.nic.publictax.adapter.NewPendingAdapter;
...
import com.nic.publictax.databinding.ActivityNewPendingScreenBinding;
...
public class NewPendingScreen extends AppCompatActivity implements Api.ServerResponseListener {
    ...
    public class fetchPendingtask extends AsyncTask<Void, Void,
        ...
        protected ArrayList<PublicTax> doInBackground(Void... params) {
            ...
            publicTaxes = dbData.getAllTreeImages();
            Log.d("Tree_COUNT", String.valueOf(publicTaxes.size()));
            return publicTaxes;
        }

        @Override
        protected void onPostExecute(ArrayList<PublicTax> treeList) {
