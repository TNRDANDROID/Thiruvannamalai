...
import com.nic.publictax.databinding.ActivityNewHomePageBinding;
import com.nic.publictax.model.PublicTax;
import com.nic.publictax.session.PrefManager;
import com.nic.publictax.support.MyLocationListener;
import com.nic.publictax.utils.CameraUtils;
...
public class NewHomePage extends AppCompatActivity {
    ...
    ArrayList<PublicTax> self_GroupList;
    ArrayList<PublicTax> self_Group_Member_List;
    ArrayList<PublicTax> fin_Year_List;
    ArrayList<PublicTax> type_tree_List;
        ...
        newHomePageBinding.groupMemberSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(position>0){
                    ...
                    ArrayList<PublicTax> getBeforeImageDetail = dbData.getParticular_Before_Save_Tree_Image_Table(self_Group_code,self_Group_member_code);
                    ArrayList<PublicTax> getAfterImageDetail = dbData.getParticular_After_Save_Tree_Image_Table(self_Group_code,self_Group_member_code);
    ...
    public void loadSelfGroupTable(){
        ...
        dbData.open();
        PublicTax self_group_list_item = new PublicTax();
    ...
    public void loadFinYearTable(){
        ...
        dbData.open();
        PublicTax fin_Year_List_item = new PublicTax();
    ...
    public void loadTypeOfTreeTable(){
        ...
        dbData.open();
        PublicTax type_tree_List_item = new PublicTax();
    ...
    public void loadSelfGroupMemberTable(){
        ...
        dbData.open();
        PublicTax self_Group_Member_List_item = new PublicTax();
    ...
    public void saveLocally(String type){
        ...
        try {
            ...
            if(type.equals("before_tree")){
                ...
                ArrayList<PublicTax> imagCount = dbData.getParticular_Before_Save_Tree_Image_Table(self_Group_code,self_Group_member_code);
                if(imagCount.size()>0){
                ...
                ArrayList<PublicTax> imagCount1 = dbData.getParticular_Before_Save_Tree_Image_Table(self_Group_code,self_Group_member_code);
                ...
                ArrayList<PublicTax> imagCount = dbData.getParticular_After_Save_Tree_Image_Table(self_Group_code,self_Group_member_code);
                if(imagCount.size()>0){
                    whereClause = "shg_code = ? and shg_member_code = ?";
                    whereArgs = new String[]{String.valueOf(self_Group_code), String.valueOf(self_Group_member_code)};
                    //  long insert_id = db.insert(DBHelper.SAVE_TREE_IMAGE_TABLE,null,values);
