...
import com.nic.publictax.adapter.NutriGardernDetailsServerAdapter;
...
import com.nic.publictax.databinding.ActivityViewNutriGardenBinding;
...
public class ViewNutriGarden extends AppCompatActivity implements Api.ServerResponseListener{
    ...
    ArrayList<PublicTax> nutriGarednDetails;
        ...
        protected Void doInBackground(JSONObject... params) {
                ...
                if (params.length > 0) {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        PublicTax nutriGardenDetails = new PublicTax();
                        try {
