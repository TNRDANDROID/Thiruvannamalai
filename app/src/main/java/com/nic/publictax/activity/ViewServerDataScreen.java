...
import com.nic.publictax.adapter.ViewServerDataListAdapter;
...
import com.nic.publictax.databinding.ViewServerDataScreenBinding;
...
public class ViewServerDataScreen extends AppCompatActivity implements Api.ServerResponseListener {
    ...
    public class fetchScheduletask extends AsyncTask<Void, Void,
        ...
        protected ArrayList<PublicTax> doInBackground(Void... params) {
            dbData.open();
            ArrayList<PublicTax> savedList = new ArrayList<>();
        ...
        @Override
        protected void onPostExecute(ArrayList<PublicTax> savedList) {
